...
钻头、锹、斧和锄是具&#x6709;_&#x6A21;块化设&#x8BA1;_&#x7684;挖掘工具。 其具有 5 种可切换的模式，对应不同的挖掘速度：
...
这些工具的升级系统可以提升工具的挖掘等级（上限）和扩展工具适用的方块种类。 锹、斧、锄适合挖掘其对应的方块种类， 而为了方便采矿工作，钻头适用于挖掘需&#x8981;_&#x9550;_&#x548C;_&#x9539;_&#x6316;掘的方块。

> ε-系列锹的默认升级模块包含精准采集效果。
...
扳手和剪刀不具有调整速度和扩展适用方块种类的能力，
但仍然支持升级模块。

> ε-系列扳手的默认升级模块能够直接将具有 `ltxi:wrench_breakable` 标签的方块的掉落物吸收进物品栏！
...
剑和斧被设计&#x4E3A;_&#x8FD1;战武器_， 其与[信号系列武器](weapons/index.md)共享部分升级模块，包括魔咒模块（剃刀和抢夺）和目标筛选器。
...
这些工具目前仅具有基础功能，没有额外的功能； 然而其组装造价低廉，因此仍然建议制作。