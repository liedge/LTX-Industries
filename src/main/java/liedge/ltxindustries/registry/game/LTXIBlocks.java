...
public final class LTXIBlocks
{
    ...
    // Helper stations
    public static final DeferredBlockWithItem<EquipmentUpgradeStationBlock, BlockItem> EQUIPMENT_UPGRADE_STATION = BLOCKS.registerBlockAndSimpleItem(LTXIIdentifiers.ID_EQUIPMENT_UPGRADE_STATION, () -> new EquipmentUpgradeStationBlock(machineProperties().noOcclusion()), new Item.Properties().stacksTo(1));

    // Machinery
    public static final DeferredBlockWithItem<EnergyCellArrayBlock, ECABlockItem> ENERGY_CELL_ARRAY = BLOCKS.registerBlockAndItem(LTXIIdentifiers.ID_ENERGY_CELL_ARRAY, () -> new EnergyCellArrayBlock(machineProperties().noOcclusion()), block -> new ECABlockItem(block, new Item.Properties().stacksTo(1)));
    public static final DeferredBlockWithItem<EnergyCellArrayBlock, InfiniteECABlockItem> INFINITE_ENERGY_CELL_ARRAY = BLOCKS.registerBlockAndItem(LTXIIdentifiers.ID_INFINITE_ENERGY_CELL_ARRAY, () -> new EnergyCellArrayBlock(machineProperties().noOcclusion()), block -> new InfiniteECABlockItem(block, new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> DIGITAL_FURNACE = registerWithEnergyTooltip(LTXIIdentifiers.ID_DIGITAL_FURNACE, () -> StateMachineBlock.staticShape(machineProperties(), LTXIBlockShapes.COOKING_MACHINE, false));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> DIGITAL_SMOKER = registerWithEnergyTooltip(LTXIIdentifiers.ID_DIGITAL_SMOKER, () -> StateMachineBlock.staticShape(machineProperties(), LTXIBlockShapes.COOKING_MACHINE, false));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> DIGITAL_BLAST_FURNACE = registerWithEnergyTooltip(LTXIIdentifiers.ID_DIGITAL_BLAST_FURNACE, () -> StateMachineBlock.staticShape(machineProperties(), LTXIBlockShapes.COOKING_MACHINE, false));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> GRINDER = registerWithEnergyTooltip(LTXIIdentifiers.ID_GRINDER, () -> StateMachineBlock.staticShape(machineProperties(), LTXIBlockShapes.COOKING_MACHINE, false));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> MATERIAL_FUSING_CHAMBER = registerWithEnergyTooltip(LTXIIdentifiers.ID_MATERIAL_FUSING_CHAMBER, () -> StateMachineBlock.staticShape(machineProperties(), LTXIBlockShapes.COOKING_MACHINE, false));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> ELECTROCENTRIFUGE = registerWithEnergyTooltip(LTXIIdentifiers.ID_ELECTROCENTRIFUGE, () -> StateMachineBlock.staticShape(machineProperties().noOcclusion(), LTXIBlockShapes.ELECTROCENTRIFUGE, true));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> MIXER = registerWithEnergyTooltip(LTXIIdentifiers.ID_MIXER, () -> StateMachineBlock.rotatingShape(machineProperties().noOcclusion(), LTXIBlockShapes.MIXER, true));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> VOLTAIC_INJECTOR = registerWithEnergyTooltip(LTXIIdentifiers.ID_VOLTAIC_INJECTOR, () -> StateMachineBlock.rotatingShape(machineProperties().noOcclusion(), LTXIBlockShapes.VOLTAIC_INJECTOR, false));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> CHEM_LAB = registerWithEnergyTooltip(LTXIIdentifiers.ID_CHEM_LAB, () -> StateMachineBlock.rotatingShape(machineProperties().noOcclusion(), LTXIBlockShapes.CHEM_LAB, false));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> ASSEMBLER = registerWithEnergyTooltip(LTXIIdentifiers.ID_ASSEMBLER, () -> StateMachineBlock.staticShape(machineProperties().noOcclusion(), LTXIBlockShapes.ASSEMBLER, false));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> GEO_SYNTHESIZER = registerWithEnergyTooltip(LTXIIdentifiers.ID_GEO_SYNTHESIZER, () -> StateMachineBlock.rotatingShape(machineProperties().noOcclusion(), LTXIBlockShapes.GEO_SYNTHESIZER, false));
    public static final DeferredBlockWithItem<PrimaryMeshBlock, BlockItem> FABRICATOR = registerWithEnergyTooltip(LTXIIdentifiers.ID_FABRICATOR, () -> PrimaryMeshBlock.create(machineProperties().noOcclusion(), LTXIBlockMeshes.WIDE_STATION, LTXIBlockShapes.FABRICATOR, true));
    public static final DeferredBlockWithItem<FabricatorBlock, BlockItem> AUTO_FABRICATOR = registerWithEnergyTooltip(LTXIIdentifiers.ID_AUTO_FABRICATOR, () -> new FabricatorBlock(machineProperties().noOcclusion()));
    public static final DeferredBlockWithItem<PrimaryMeshBlock, BlockItem> MOLECULAR_RECONSTRUCTOR = registerWithEnergyTooltip(LTXIIdentifiers.ID_MOLECULAR_RECONSTRUCTOR, () -> PrimaryMeshBlock.create(machineProperties().noOcclusion(), LTXIBlockMeshes.DOUBLE_VERTICAL, LTXIBlockShapes.MOLECULAR_RECONSTRUCTOR, false));
    public static final DeferredBlockWithItem<PrimaryMeshBlock, BlockItem> DIGITAL_GARDEN = registerWithEnergyTooltip(LTXIIdentifiers.ID_DIGITAL_GARDEN, () -> PrimaryMeshBlock.create(machineProperties().noCollission(), LTXIBlockMeshes.DOUBLE_VERTICAL, LTXIBlockShapes.DIGITAL_GARDEN, false));
    public static final DeferredBlockWithItem<PrimaryMeshBlock, BlockItem> ROCKET_TURRET = BLOCKS.registerBlockAndItem(LTXIIdentifiers.ID_ROCKET_TURRET, () -> PrimaryMeshBlock.create(machineProperties().noOcclusion(), LTXIBlockMeshes.DOUBLE_VERTICAL, LTXIBlockShapes.GENERAL_TURRET, true), block -> ContentsTooltipBlockItem.energyOwnerTooltipItem(block, new Item.Properties().stacksTo(1).rarity(LTXIItemRarities.ltxGearRarity())));
    public static final DeferredBlockWithItem<PrimaryMeshBlock, BlockItem> RAILGUN_TURRET = BLOCKS.registerBlockAndItem(LTXIIdentifiers.ID_RAILGUN_TURRET, () -> PrimaryMeshBlock.create(machineProperties().noOcclusion(), LTXIBlockMeshes.DOUBLE_VERTICAL, LTXIBlockShapes.GENERAL_TURRET, true), block -> ContentsTooltipBlockItem.energyOwnerTooltipItem(block, new Item.Properties().stacksTo(1).rarity(LTXIItemRarities.ltxGearRarity())));
