...
public final class LTXIBlocks
{
    ...
    public static final DeferredBlockWithItem<PrimaryMeshBlock, BlockItem> MOLECULAR_RECONSTRUCTOR = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_MOLECULAR_RECONSTRUCTOR, () -> new PrimaryMeshBlock(machineProperties().noOcclusion(), LTXIBlockMeshes.DOUBLE_VERTICAL, LTXIBlockShapes.MOLECULAR_RECONSTRUCTOR, false), block -> ContentsTooltipBlockItem.energyTooltipItem(block, new Item.Properties().stacksTo(1)));
    ...
    public static final DeferredBlockWithItem<PrimaryMeshBlock, BlockItem> ROCKET_TURRET = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_ROCKET_TURRET, () -> new PrimaryMeshBlock(machineProperties().noOcclusion(), LTXIBlockMeshes.DOUBLE_VERTICAL, LTXIBlockShapes.GENERAL_TURRET, true), block -> ContentsTooltipBlockItem.energyOwnerTooltipItem(block, new Item.Properties().stacksTo(1).rarity(LTXIItemRarities.ltxGearRarity())));
    public static final DeferredBlockWithItem<PrimaryMeshBlock, BlockItem> RAILGUN_TURRET = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_RAILGUN_TURRET, () -> new PrimaryMeshBlock(machineProperties().noOcclusion(), LTXIBlockMeshes.DOUBLE_VERTICAL, LTXIBlockShapes.GENERAL_TURRET, true), block -> ContentsTooltipBlockItem.energyOwnerTooltipItem(block, new Item.Properties().stacksTo(1).rarity(LTXIItemRarities.ltxGearRarity())));
