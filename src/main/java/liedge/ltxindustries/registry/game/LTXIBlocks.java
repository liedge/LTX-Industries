...
public final class LTXIBlocks
{
    ...
    public static final DeferredBlockWithItem<BasicMachineBlock, ContentsTooltipBlockItem> GRINDER = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_GRINDER, () -> new BasicMachineBlock(machineProperties()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), true, true));
    public static final DeferredBlockWithItem<BasicMachineBlock, ContentsTooltipBlockItem> RECOMPOSER = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_RECOMPOSER, () -> new BasicMachineBlock(machineProperties()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), true, true));
    public static final DeferredBlockWithItem<BasicMachineBlock, ContentsTooltipBlockItem> MATERIAL_FUSING_CHAMBER = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_MATERIAL_FUSING_CHAMBER, () -> new BasicMachineBlock(machineProperties()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), true, true));
    public static final DeferredBlockWithItem<FabricatorBlock, ContentsTooltipBlockItem> FABRICATOR = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_FABRICATOR, () -> new FabricatorBlock(machineProperties().noOcclusion()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), true, true));
    public static final DeferredBlockWithItem<FabricatorBlock, ContentsTooltipBlockItem> AUTO_FABRICATOR = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_AUTO_FABRICATOR, () -> new FabricatorBlock(machineProperties().noOcclusion()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), true, false));

    public static final DeferredBlockWithItem<MolecularReconstructorBlock, ContentsTooltipBlockItem> MOLECULAR_RECONSTRUCTOR = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_MOLECULAR_RECONSTRUCTOR, () -> new MolecularReconstructorBlock(machineProperties().noOcclusion()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), true, true));

    public static final DeferredBlockWithItem<EquipmentUpgradeStationBlock, ContentsTooltipBlockItem> EQUIPMENT_UPGRADE_STATION = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_EQUIPMENT_UPGRADE_STATION, () -> new EquipmentUpgradeStationBlock(machineProperties().noOcclusion()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), false, true));
