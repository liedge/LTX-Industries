...
public final class LTXIBlocks
{
    ...
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> DIGITAL_FURNACE = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_DIGITAL_FURNACE, () -> StateMachineBlock.staticShape(machineProperties(), StateMachineShapes.COOKING_MACHINE_SHAPE, false), block -> ContentsTooltipBlockItem.energyTooltipItem(block, new Item.Properties().stacksTo(1)));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> DIGITAL_SMOKER = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_DIGITAL_SMOKER, () -> StateMachineBlock.staticShape(machineProperties(), StateMachineShapes.COOKING_MACHINE_SHAPE, false), block -> ContentsTooltipBlockItem.energyTooltipItem(block, new Item.Properties().stacksTo(1)));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> DIGITAL_BLAST_FURNACE = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_DIGITAL_BLAST_FURNACE, () -> StateMachineBlock.staticShape(machineProperties(), StateMachineShapes.COOKING_MACHINE_SHAPE, false), block -> ContentsTooltipBlockItem.energyTooltipItem(block, new Item.Properties().stacksTo(1)));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> GRINDER = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_GRINDER, () -> StateMachineBlock.staticShape(machineProperties(), StateMachineShapes.COOKING_MACHINE_SHAPE, false), block -> ContentsTooltipBlockItem.energyTooltipItem(block, new Item.Properties().stacksTo(1)));
    ...
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> ELECTROCENTRIFUGE = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_ELECTROCENTRIFUGE, () -> StateMachineBlock.staticShape(machineProperties().noOcclusion(), StateMachineShapes.ELECTROCENTRIFUGE_SHAPE, true), block -> ContentsTooltipBlockItem.energyTooltipItem(block, new Item.Properties().stacksTo(1)));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> MIXER = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_MIXER, () -> StateMachineBlock.rotatingShape(machineProperties().noOcclusion(), StateMachineShapes.MIXER_SHAPE, true), block -> ContentsTooltipBlockItem.energyTooltipItem(block, new Item.Properties().stacksTo(1)));
    public static final DeferredBlockWithItem<StateMachineBlock, BlockItem> CHEM_LAB = BLOCKS.registerBlockAndItem(LTXICommonIds.ID_CHEM_LAB, () -> StateMachineBlock.rotatingShape(machineProperties().noOcclusion(), StateMachineShapes.CHEM_LAB_SHAPE, false), block -> ContentsTooltipBlockItem.energyTooltipItem(block, new Item.Properties().stacksTo(1)));
