...
public final class LTXIBlocks
{
    ...
    public static final DeferredBlock<PrimaryMeshBlock> MOLECULAR_RECONSTRUCTOR = BLOCKS.registerBlock(LTXIIdentifiers.ID_MOLECULAR_RECONSTRUCTOR, properties -> PrimaryMeshBlock.create(properties, LTXIBlockMeshes.DOUBLE_VERTICAL, LTXIBlockShapes.MOLECULAR_RECONSTRUCTOR, false), LTXIBlocks::machineProperties);
