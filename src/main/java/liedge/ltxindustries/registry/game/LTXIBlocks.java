...
public final class LTXIBlocks
{
    ...
    // Helper stations
    public static final DeferredBlock<SimpleWrenchBlock> EQUIPMENT_UPGRADE_STATION = BLOCKS.registerBlock(LTXIIdentifiers.ID_EQUIPMENT_UPGRADE_STATION, properties -> SimpleWrenchBlock.rotatingShape(properties, LTXIBlockShapes.UPGRADE_TABLE), machineProperties());

    // Machinery
    public static final DeferredBlock<SimpleWrenchBlock> ENERGY_CELL_ARRAY = BLOCKS.registerBlock(LTXIIdentifiers.ID_ENERGY_CELL_ARRAY, properties -> SimpleWrenchBlock.staticShape(properties, LTXIBlockShapes.ENERGY_CELL_ARRAY), machineProperties());
    public static final DeferredBlock<SimpleWrenchBlock> INFINITE_ENERGY_CELL_ARRAY = BLOCKS.registerBlock(LTXIIdentifiers.ID_INFINITE_ENERGY_CELL_ARRAY, properties -> SimpleWrenchBlock.staticShape(properties, LTXIBlockShapes.ENERGY_CELL_ARRAY), machineProperties());
    ...
    public static final DeferredBlock<StateMachineBlock> GRINDER = BLOCKS.registerBlock(LTXIIdentifiers.ID_GRINDER, properties -> StateMachineBlock.rotatingShape(properties, LTXIBlockShapes.GRINDER, true), machineProperties());
    ...
    public static final DeferredBlock<StateMachineBlock> MIXER = BLOCKS.registerBlock(LTXIIdentifiers.ID_MIXER, properties -> StateMachineBlock.staticShape(properties, LTXIBlockShapes.MIXER, true), machineProperties());
    public static final DeferredBlock<StateMachineBlock> VOLTAIC_INJECTOR = BLOCKS.registerBlock(LTXIIdentifiers.ID_VOLTAIC_INJECTOR, properties -> StateMachineBlock.rotatingShape(properties, LTXIBlockShapes.VOLTAIC_INJECTOR, true), machineProperties());
    ...
    public static final DeferredBlock<SimpleWrenchBlock> AUTO_FABRICATOR = BLOCKS.registerBlock(LTXIIdentifiers.ID_AUTO_FABRICATOR, properties -> SimpleWrenchBlock.staticShape(properties, LTXIBlockShapes.ASSEMBLER), machineProperties());
