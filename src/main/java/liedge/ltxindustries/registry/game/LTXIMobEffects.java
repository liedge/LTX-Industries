...
public final class LTXIMobEffects
{
    ...
    public static final DeferredHolder<MobEffect, MobEffect> GLOOM = MOB_EFFECTS.register("gloom", id -> new SimpleMobEffect(MobEffectCategory.HARMFUL, LTXIConstants.GLOOM_BLUE.argb32())
