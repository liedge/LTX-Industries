...
public final class LTXIUpgradeEffectComponents
{
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<CaptureLoot.MobDrops>> CAPTURE_MOB_DROPS = COMPONENTS.register("capture_mob_drops", () -> UpgradeDataComponentType.create(CaptureLoot.MobDrops.CODEC));
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<CaptureLoot.MobExperience>> CAPTURE_MOB_EXPERIENCE = COMPONENTS.register("capture_mob_experience", () -> UpgradeDataComponentType.create(CaptureLoot.MobExperience.CODEC));
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<List<LootItemCondition>>> TARGET_CONDITIONS = COMPONENTS.register("target_conditions", () -> UpgradeDataComponentType.custom(LimaLootUtil.conditionsCodec(LootContextParamSets.CHEST)));
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<CancelFall>> CANCEL_FALLS = COMPONENTS.register("cancel_falls", () -> UpgradeDataComponentType.create(CancelFall.CODEC));
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<List<CaptureLoot.BlockDrops>>> CAPTURE_BLOCK_DROPS = COMPONENTS.register("capture_block_drops", () -> UpgradeDataComponentType.createList(CaptureLoot.BlockDrops.CODEC));
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<List<ValueOperation>>> ENERGY_GENERATION = COMPONENTS.registerValue("energy_generation");
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Holder<RecipeMode>>> UNLOCK_RECIPE_MODE = COMPONENTS.register("unlock_recipe_mode", () -> UpgradeDataComponentType.custom(RecipeMode.CODEC));
    //#endregion
