...
public final class LTXIUpgradeEffectComponents
{
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<List<DamageAttributesUpgradeEffect>>> DAMAGE_ATTRIBUTE_MODIFIERS = COMPONENTS.register("damage_attribute_modifier", () -> UpgradeDataComponentType.listOf(DamageAttributesUpgradeEffect.CODEC));
