...
public final class LTXIMenus
{
    ...
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<GrinderBlockEntity, RecipeLayoutMenu<GrinderBlockEntity>>> GRINDER = registerLayoutRecipeMenu(LTXIIdentifiers.ID_GRINDER, GrinderBlockEntity.class, RecipeLayouts.GRINDING);
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<MaterialPressBlockEntity, RecipeLayoutMenu<MaterialPressBlockEntity>>> MATERIAL_PRESS = registerLayoutRecipeMenu(LTXIIdentifiers.ID_MATERIAL_PRESS, MaterialPressBlockEntity.class, RecipeLayouts.PRESSING);
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<MaterialFusingChamberBlockEntity, RecipeLayoutMenu<MaterialFusingChamberBlockEntity>>> MATERIAL_FUSING_CHAMBER = registerLayoutRecipeMenu(LTXIIdentifiers.ID_MATERIAL_FUSING_CHAMBER, MaterialFusingChamberBlockEntity.class, RecipeLayouts.FUSING);
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<HydroSieveBlockEntity, RecipeLayoutMenu<HydroSieveBlockEntity>>> HYDROSIEVE = registerLayoutRecipeMenu(LTXIIdentifiers.ID_HYDROSIEVE, HydroSieveBlockEntity.class, RecipeLayouts.SIEVING);
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<ElectroCentrifugeBlockEntity, RecipeLayoutMenu<ElectroCentrifugeBlockEntity>>> ELECTROCENTRIFUGE = registerLayoutRecipeMenu(LTXIIdentifiers.ID_ELECTROCENTRIFUGE, ElectroCentrifugeBlockEntity.class, RecipeLayouts.ELECTRO_CENTRIFUGING);
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<MixerBlockEntity, RecipeLayoutMenu<MixerBlockEntity>>> MIXER = registerLayoutRecipeMenu(LTXIIdentifiers.ID_MIXER, MixerBlockEntity.class, RecipeLayouts.MIXING);
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<VoltaicInjectorBlockEntity, RecipeLayoutMenu<VoltaicInjectorBlockEntity>>> VOLTAIC_INJECTOR = registerLayoutRecipeMenu(LTXIIdentifiers.ID_VOLTAIC_INJECTOR, VoltaicInjectorBlockEntity.class, RecipeLayouts.ENERGIZING);
