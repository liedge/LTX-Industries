...
public final class LTXIMenus
{
    ...
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<AssemblerBlockEntity, RecipeLayoutMenu<AssemblerBlockEntity>>> ASSEMBLER = registerLayoutRecipeMenu(LTXICommonIds.ID_ASSEMBLER, AssemblerBlockEntity.class, RecipeLayouts.ASSEMBLING);
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<GeoSynthesizerBlockEntity, RecipeLayoutMenu<GeoSynthesizerBlockEntity>>> GEO_SYNTHESIZER = registerLayoutRecipeMenu(LTXICommonIds.ID_GEO_SYNTHESIZER, GeoSynthesizerBlockEntity.class, RecipeLayouts.GEO_SYNTHESIS);
