...
public final class LTXIMenus
{
    ...
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<ArcFurnaceBlockEntity, RecipeLayoutMenu<ArcFurnaceBlockEntity>>> ARC_FURNACE = registerLayoutRecipeMenu(LTXIIdentifiers.ID_ARC_FURNACE, ArcFurnaceBlockEntity.class, RecipeLayouts.ARC_SMELTING);
