...
public final class LTXIMenus
{
    ...
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<VoltaicInjectorBlockEntity, RecipeLayoutMenu<VoltaicInjectorBlockEntity>>> VOLTAIC_INJECTOR = registerLayoutRecipeMenu(LTXICommonIds.ID_VOLTAIC_INJECTOR, VoltaicInjectorBlockEntity.class, RecipeLayouts.COOKING_LAYOUT);
    ...
    public static final DeferredHolder<MenuType<?>, BlockEntityMenuType<DigitalGardenBlockEntity, RecipeLayoutMenu<DigitalGardenBlockEntity>>> DIGITAL_GARDEN = registerLayoutRecipeMenu(LTXICommonIds.ID_DIGITAL_GARDEN, DigitalGardenBlockEntity.class, RecipeLayouts.DIGITAL_GARDEN);
