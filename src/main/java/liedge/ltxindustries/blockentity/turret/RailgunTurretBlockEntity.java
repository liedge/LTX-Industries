...
public class RailgunTurretBlockEntity extends SemiAutoTurretBlockEntity
{
    ...
    protected void attackTarget(ServerLevel level, BlockPos pos, BlockState state, @Nullable Player owner, Entity target)
    {
        ...
        LimaNetworkUtil.sendParticle(level, ColorParticleOptions.of(LTXIParticles.RAILGUN_BOLT, LTXIConstants.LIME_GREEN), LimaNetworkUtil.LONG_PARTICLE_DIST, traceStart, target.getBoundingBox().getCenter());
