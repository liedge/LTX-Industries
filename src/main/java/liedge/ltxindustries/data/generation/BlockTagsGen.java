...
class BlockTagsGen extends LimaTagsProvider.RegistryTags<Block>
{
    ...
    protected void addTags(HolderLookup.Provider lookup)
    {
        ...
        buildTag(IMPERMEABLE).add(TITANIUM_PANEL, SMOOTH_TITANIUM_PANEL, TILED_TITANIUM_PANEL, TITANIUM_GLASS, SLATESTEEL_PANEL, SMOOTH_SLATESTEEL_PANEL, TILED_SLATESTEEL_PANEL).addTag(NEON_LIGHT_BLOCKS);
