...
class ItemTagsGen extends LimaTagsProvider.ItemTags
{
    ...
    protected void addTags(HolderLookup.Provider lookup)
    {
        ...
        buildTag(MINING_TOOLS).add(LTX_DRILL, LTX_SHOVEL, LTX_AXE, LTX_HOE);
        buildTag(ALL_TOOLS).add(LTX_SHEARS, LTX_BRUSH, LTX_FISHING_ROD, LTX_WRENCH, LTX_LIGHTER).addTags(MINING_TOOLS, MELEE_WEAPONS);
    }
}