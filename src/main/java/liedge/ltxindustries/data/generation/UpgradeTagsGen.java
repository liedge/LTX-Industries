...
class UpgradeTagsGen extends LimaTagsProvider<Upgrade>
{
    ...
    protected void addTags(HolderLookup.Provider registries)
    {
        ...
        buildTag(RELOAD_SOURCE_MODIFIERS).add(INFINITE_AMMO);

        buildTag(MACHINE_TIER).add(POWER_TIERS);
        buildTag(PARALLEL_OPS_UPGRADES).add(PARALLEL_TIERS, GEO_SYNTHESIZER_PARALLEL);
