...
public final class AutoFabricatorCraftingMachine implements ICraftingMachine
{
    ...
    {
        return !blockEntity.isCrafting() && blockEntity.getItemsOrThrow(BlockContentsType.AUXILIARY).getResource(BaseFabricatorBlockEntity.AUX_BLUEPRINT_SLOT).isEmpty();
    }
}