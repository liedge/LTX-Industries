...
public final class LTXILangKeys
{
    ...
    public static final Translatable GUI_ENABLED = gui("enabled");
    public static final Translatable GUI_DISABLED = gui("disabled");
    public static final Translatable GUI_UPGRADES = gui("upgrades");
    public static final Translatable GUI_LIGHT_COLORS = gui("light_colors");
    public static final Translatable MANAGE_UPGRADES = gui("manage_upgrades");
    public static final Translatable MANAGE_LIGHT_COLORS = gui("manage_light_colors");
    ...
    private static Translatable gui(String key)
    {
        return prefixKey("gui", key);
    }
