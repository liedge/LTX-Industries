...
public record AddDamageAttributes(Holder<Attribute> attribute, RankBasedAttributeModifier modifier) implements AttributeModifierUpgradeEffect
{
    ...
    public static AddDamageAttributes create(Holder<Attribute> attribute, Identifier modifierId, LevelBasedValue amount, AttributeModifier.Operation operation)
    {
    ...
    {
        return LTXILangKeys.DAMAGE_ATTRIBUTES_EFFECT_PREFIX.translate().withStyle(LTXIChatStyles.HOSTILE_ORANGE);
    }
}