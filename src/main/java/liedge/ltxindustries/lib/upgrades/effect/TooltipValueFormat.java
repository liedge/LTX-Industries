...
public enum TooltipValueFormat implements StringRepresentable
{
    ...
    public static final Codec<TooltipValueFormat> CODEC = LimaEnumCodec.create(TooltipValueFormat.class);

    private final String name;
    private final DoubleFunction<MutableComponent> function;

    TooltipValueFormat(String name, DoubleFunction<MutableComponent> function)
    {
        this.name = name;
