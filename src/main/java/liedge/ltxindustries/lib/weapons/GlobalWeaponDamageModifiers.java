...
public final class GlobalWeaponDamageModifiers
{
    ...
    public static final AdvancedDataMapType<EntityType<?>, List<WeaponDamageModifier>, ?> DATA_MAP_TYPE = AdvancedDataMapType.builder(LTXIndustries.RESOURCES.location("weapon_damage_modifier"), Registries.ENTITY_TYPE, CODEC)
            .synced(CODEC, false)
