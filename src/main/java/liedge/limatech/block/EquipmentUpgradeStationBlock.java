...
public class EquipmentUpgradeStationBlock extends BaseWrenchEntityBlock
{
    ...
    public EquipmentUpgradeStationBlock(Properties properties)
    {
        super(properties);
    }
    ...
    {
        return LimaTechBlockEntities.EQUIPMENT_UPGRADE_STATION.get();
    }
