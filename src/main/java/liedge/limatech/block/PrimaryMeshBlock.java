...
public abstract class PrimaryMeshBlock extends BaseMeshBlock
{
    ...
    {
        super(properties);
        this.blockMesh = Objects.requireNonNull(LimaTechBlockMeshes.getBlockMesh(blockMeshId));
    }
    ...
    public void setPlacedBy(Level level, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack)
    {
        ...
        {
            BlockState cursorState = LimaTechBlocks.MESH_BLOCK.get().defaultBlockState()
