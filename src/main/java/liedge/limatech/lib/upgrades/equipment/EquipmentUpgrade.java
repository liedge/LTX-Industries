...
public record EquipmentUpgrade(Component title, Component description, int maxRank, HolderSet<Item> supportedSet, HolderSet<EquipmentUpgrade> exclusiveSet, UpgradeEffectMap effects, UpgradeIcon icon) implements UpgradeBase<Item, EquipmentUpgrade>
{
    public static final Codec<EquipmentUpgrade> DIRECT_CODEC = UpgradeBase.createDirectCodec(Registries.ITEM, LimaTechRegistries.EQUIPMENT_UPGRADES_KEY, EquipmentUpgrade::new);
