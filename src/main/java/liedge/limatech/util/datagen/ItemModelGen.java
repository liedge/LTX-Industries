...
class ItemModelGen extends LimaItemModelProvider
{
    ...
    protected void registerModels()
    {
        ...
        generated(DEEPSLATE_POWDER, SLATE_ALLOY_INGOT, BEDROCK_ALLOY_INGOT, SLATE_ALLOY_NUGGET, COPPER_CIRCUIT, GOLD_CIRCUIT, NIOBIUM_CIRCUIT, AUTO_AMMO_CANISTER, SPECIALIST_AMMO_CANISTER, EXPLOSIVES_AMMO_CANISTER, MAGNUM_AMMO_CANISTER);
