...
class DamageTagsGen extends LimaTagsProvider<DamageType>
{
    ...
    protected void addTags(HolderLookup.Provider lookup)
    {
        ...
        reverseTag(FLAME_GRENADE, IS_FIRE);
        reverseTag(ROCKET_LAUNCHER, IS_EXPLOSION);
        tag(BYPASSES_COOLDOWN).add(EXPLOSIVE_GRENADE, FLAME_GRENADE, FREEZE_GRENADE, ELECTRIC_GRENADE, ACID_GRENADE, NEURO_GRENADE, ROCKET_LAUNCHER);
