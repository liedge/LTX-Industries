...
class BlockTagsGen extends BlockTagsProvider implements TagBuilderHelper<Block>
{
    ...
    protected void addTags(HolderLookup.Provider lookup)
    {
        ...
        buildTag(NEEDS_STONE_TOOL).add(TITANIUM_ORE, DEEPSLATE_TITANIUM_ORE, RAW_TITANIUM_BLOCK, TITANIUM_BLOCK, FABRICATOR, ROCKET_TURRET).copyValuesTo(MINEABLE_WITH_PICKAXE);
