...
class BlockTagsGen extends LimaTagsProvider.RegistryTags<Block>
{
    ...
    protected void addTags(HolderLookup.Provider lookup)
    {
        ...
        buildTag(NEEDS_STONE_TOOL).add(TITANIUM_ORE, DEEPSLATE_TITANIUM_ORE, RAW_TITANIUM_BLOCK, TITANIUM_BLOCK, TIERED_ENERGY_STORAGE_ARRAY, INFINITE_ENERGY_STORAGE_ARRAY, DIGITAL_FURNACE, GRINDER, RECOMPOSER, MATERIAL_FUSING_CHAMBER, FABRICATOR, EQUIPMENT_MOD_TABLE, ROCKET_TURRET).copyTo(MINEABLE_WITH_PICKAXE);
