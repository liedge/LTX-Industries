...
public abstract class BaseRocketEntity extends AutoTrackingProjectile
{
    ...
    protected void onProjectileHit(Level level, HitResult hitResult, Vec3 hitLocation)
    {
        ...
        LimaNetworkUtil.sendParticle(level, new ColorParticleOptions(LimaTechParticles.HALF_SONIC_BOOM_EMITTER, LimaTechConstants.LIME_GREEN), LimaNetworkUtil.UNLIMITED_PARTICLE_DIST, hitLocation);
