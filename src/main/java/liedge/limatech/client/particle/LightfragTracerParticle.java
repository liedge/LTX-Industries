...
public class LightfragTracerParticle extends CustomRenderTypeParticle
{
    ...
    protected final void renderParticle(VertexConsumer buffer, Matrix4f mx4, Camera camera, float partialTicks)
    {
        ...
        // Render main 'bolt'
        LimaTechRenderUtil.renderPositionColorCuboid(buffer, mx4, -LIGHTFRAG_HALF_SIZE, -LIGHTFRAG_HALF_SIZE, 0f, LIGHTFRAG_HALF_SIZE, LIGHTFRAG_HALF_SIZE, 0.125f, color, a1, LimaTechRenderUtil.ALL_SIDES);
        // Render trail
        LimaTechRenderUtil.renderPositionColorCuboid(buffer, mx4, -LIGHTFRAG_HALF_SIZE, -LIGHTFRAG_HALF_SIZE, -trailLength, LIGHTFRAG_HALF_SIZE, LIGHTFRAG_HALF_SIZE, 0f, color, a2, LimaTechRenderUtil.ALL_SIDES);
    }
