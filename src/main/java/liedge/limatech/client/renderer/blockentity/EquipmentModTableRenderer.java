...
public class EquipmentModTableRenderer extends LimaBlockEntityRenderer<EquipmentModTableBlockEntity>
{
    public EquipmentModTableRenderer(BlockEntityRendererProvider.Context context)
    {
        super(context);
    }

    @Override
    public void render(EquipmentModTableBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay)
    {
