...
public class RocketModel extends Model
{
    ...
    public RocketModel(EntityModelSet set)
    {
        super(RenderType::entitySolid);
        ModelPart root = set.bakeLayer(LimaTechModelLayers.ROCKET);
        rocket = root.getChild("rocket");
    ...
    {
        rocket.render(poseStack, buffer, light, overlay);
    ...
    public static LayerDefinition defineLayer()
    {
        ...
        partDef.addOrReplaceChild("rocket", CubeListBuilder.create()
