...
public class EnergyShearsItem extends EnergyMiningToolItem
{
    ...
    {
        return super.mineBlock(stack, level, state, pos, miningEntity) && state.is(LimaTechTags.Blocks.SHEARS_HARVESTABLE);
    }
