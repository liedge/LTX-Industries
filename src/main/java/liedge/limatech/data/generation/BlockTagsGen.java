...
class BlockTagsGen extends LimaTagsProvider.RegistryTags<Block>
{
    ...
    protected void addTags(HolderLookup.Provider lookup)
    {
        ...
        buildTag(NEEDS_STONE_TOOL).add(TITANIUM_ORE, DEEPSLATE_TITANIUM_ORE, RAW_TITANIUM_BLOCK, TITANIUM_BLOCK, ENERGY_STORAGE_ARRAY, INFINITE_ENERGY_STORAGE_ARRAY, DIGITAL_FURNACE, GRINDER, RECOMPOSER, MATERIAL_FUSING_CHAMBER, FABRICATOR, AUTO_FABRICATOR, EQUIPMENT_UPGRADE_STATION,
                MOLECULAR_RECONSTRUCTOR, ROCKET_TURRET, RAILGUN_TURRET).copyTo(MINEABLE_WITH_PICKAXE);
        ...
        buildTag(WRENCH_BREAKABLE).add(DIGITAL_FURNACE, GRINDER, RECOMPOSER, MATERIAL_FUSING_CHAMBER, FABRICATOR, AUTO_FABRICATOR, EQUIPMENT_UPGRADE_STATION, MOLECULAR_RECONSTRUCTOR, ENERGY_STORAGE_ARRAY, INFINITE_ENERGY_STORAGE_ARRAY, ROCKET_TURRET, RAILGUN_TURRET);
