...
class BlockTagsGen extends LimaTagsProvider.RegistryTags<Block>
{
    ...
    protected void addTags(HolderLookup.Provider lookup)
    {
        ...
        buildTag(WRENCH_BREAKABLE).add(DIGITAL_FURNACE, GRINDER, RECOMPOSER, MATERIAL_FUSING_CHAMBER, FABRICATOR, AUTO_FABRICATOR, EQUIPMENT_UPGRADE_STATION, ENERGY_STORAGE_ARRAY, INFINITE_ENERGY_STORAGE_ARRAY, ROCKET_TURRET, RAILGUN_TURRET);
