...
public final class LimaTechPlacedFeatures
{
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context)
    {
        ...
        PlacedFeature fortressBilevine = new PlacedFeature(configs.getOrThrow(LimaTechConfiguredFeatures.BILEVINE_CONFIG), List.of(
        ...
        PlacedFeature bastionBilevine = new PlacedFeature(configs.getOrThrow(LimaTechConfiguredFeatures.BILEVINE_CONFIG), List.of(
