...
public final class LimaTechRecipeSerializers
{
    ...
    public static final DeferredHolder<RecipeSerializer<?>, LimaRecipeSerializer<GrindingRecipe>> GRINDING = SERIALIZERS.register("grinding", id -> LimaSimpleRecipe.maxIngredientsSerializer(id, GrindingRecipe::new, 1));
    public static final DeferredHolder<RecipeSerializer<?>, LimaRecipeSerializer<RecomposingRecipe>> RECOMPOSING = SERIALIZERS.register("recomposing", id -> LimaSimpleRecipe.maxIngredientsSerializer(id, RecomposingRecipe::new, 1));
    public static final DeferredHolder<RecipeSerializer<?>, LimaRecipeSerializer<MaterialFusingRecipe>> MATERIAL_FUSING = SERIALIZERS.register("material_fusing", id -> LimaSimpleRecipe.maxIngredientsSerializer(id, MaterialFusingRecipe::new, 3));
