...
public final class LimaTechBlockEntities
{
    ...
    public static void registerCapabilities(RegisterCapabilitiesEvent event)
    {
        ...
        Stream.of(ENERGY_STORAGE_ARRAY, DIGITAL_FURNACE, GRINDER, RECOMPOSER, MATERIAL_FUSING_CHAMBER, FABRICATOR).map(DeferredHolder::get).forEach(machineType ->
        {
    ...
    public static final DeferredHolder<BlockEntityType<?>, LimaBlockEntityType<EnergyStorageArrayBlockEntity>> ENERGY_STORAGE_ARRAY = TYPES.register("energy_storage_array", () -> LimaBlockEntityType.of(EnergyStorageArrayBlockEntity::new, LimaTechBlocks.ENERGY_STORAGE_ARRAY));
