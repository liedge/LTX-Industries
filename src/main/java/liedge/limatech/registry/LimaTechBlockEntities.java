...
public final class LimaTechBlockEntities
{
    ...
    public static final DeferredHolder<BlockEntityType<?>, LimaBlockEntityType<BaseESABlockEntity>> ENERGY_STORAGE_ARRAY = TYPES.register("energy_storage_array", () -> LimaBlockEntityType.of(EnergyStorageArrayBlockEntity::new, LimaTechBlocks.ENERGY_STORAGE_ARRAY));
    public static final DeferredHolder<BlockEntityType<?>, LimaBlockEntityType<BaseESABlockEntity>> INFINITE_ENERGY_STORAGE_ARRAY = TYPES.register("infinite_energy_storage_array", () -> LimaBlockEntityType.of(InfiniteESABlockEntity::new, LimaTechBlocks.INFINITE_ENERGY_STORAGE_ARRAY));
