...
public final class LimaTechBlocks
{
    ...
    public static final DeferredBlockWithItem<BasicHorizontalMachineBlock, ContentsTooltipBlockItem> DIGITAL_FURNACE = BLOCKS.registerBlockAndItem(LimaTechIds.ID_DIGITAL_FURNACE, () -> new BasicHorizontalMachineBlock(machineProperties()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), true, true));
    public static final DeferredBlockWithItem<BasicHorizontalMachineBlock, ContentsTooltipBlockItem> GRINDER = BLOCKS.registerBlockAndItem(LimaTechIds.ID_GRINDER, () -> new BasicHorizontalMachineBlock(machineProperties()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), true, true));
    public static final DeferredBlockWithItem<BasicHorizontalMachineBlock, ContentsTooltipBlockItem> RECOMPOSER = BLOCKS.registerBlockAndItem(LimaTechIds.ID_RECOMPOSER, () -> new BasicHorizontalMachineBlock(machineProperties()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), true, true));
    public static final DeferredBlockWithItem<BasicHorizontalMachineBlock, ContentsTooltipBlockItem> MATERIAL_FUSING_CHAMBER = BLOCKS.registerBlockAndItem(LimaTechIds.ID_MATERIAL_FUSING_CHAMBER, () -> new BasicHorizontalMachineBlock(machineProperties()), block -> new ContentsTooltipBlockItem(block, new Item.Properties().stacksTo(1), true, true));
